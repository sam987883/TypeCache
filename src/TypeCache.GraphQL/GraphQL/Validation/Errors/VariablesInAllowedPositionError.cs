...
public class VariablesInAllowedPositionError : ValidationError
{
	...
	{
		this.Locations.Add(Location.FromLinearPosition(context.Document.Source, varDef.Location.Start));
		this.Locations.Add(Location.FromLinearPosition(context.Document.Source, usage.Node.Location.Start));
	}

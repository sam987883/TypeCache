...
public interface INameConverter
{
	...
	/// </summary>
	string NameForField(string fieldName, IObjectGraphType parentGraphType);

	/// <summary>
	/// Sanitizes an argument name for a specified parent graph type and field definition; returns the updated field name
	/// </summary>
	string NameForArgument(string argumentName, IObjectGraphType parentGraphType, IFieldType field);
}

...
public class DefaultNameConverter : INameConverter
{
	...
	/// </summary>
	public string NameForField(string fieldName, IObjectGraphType parentGraphType) => fieldName;

	/// <summary>
	/// Returns the argument name without modification
	/// </summary>
	public string NameForArgument(string argumentName, IObjectGraphType parentGraphType, IFieldType field) => argumentName;
}

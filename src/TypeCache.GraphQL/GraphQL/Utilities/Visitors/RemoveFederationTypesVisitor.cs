...
{
    private static readonly HashSet<string> _federatedDirectives = new(StringComparer.Ordinal)
    {
        "external",
        "provides",
        "requires",
    ...
    private static readonly HashSet<string> _federatedTypes = new(StringComparer.Ordinal)
	{
        "_Entity",
        "_Any",
        "FieldSet",

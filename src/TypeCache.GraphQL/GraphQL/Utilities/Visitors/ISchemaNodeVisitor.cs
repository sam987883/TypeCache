...
namespace GraphQL.Utilities
{
    ...
    public interface ISchemaNodeVisitor
    {
		...
		/// <summary>
		/// Visits registered within the schema <see cref="GraphQLEnumType"/>.
		/// </summary>
		void VisitEnum(GraphQLEnumType type, ISchema schema);

		/// <summary>
		/// Visits <see cref="GraphQLEnumType.EnumValue"/> of registered within the schema <see cref="GraphQLEnumType"/>.
		/// </summary>
		void VisitEnumValue(GraphQLEnumType.EnumValue value, GraphQLEnumType type, ISchema schema);
    }
}

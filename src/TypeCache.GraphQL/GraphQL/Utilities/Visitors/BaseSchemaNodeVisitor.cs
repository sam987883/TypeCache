...
namespace GraphQL.Utilities
{
    ...
    public abstract class BaseSchemaNodeVisitor : ISchemaNodeVisitor
    {
        ...
        /// <inheritdoc />
        public virtual void VisitEnum(GraphQLEnumType type, ISchema schema)
        {
        }

        /// <inheritdoc />
        public virtual void VisitEnumValue(GraphQLEnumType.EnumValue value, GraphQLEnumType type, ISchema schema)
        {
        }
    }
}

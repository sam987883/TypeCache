...
public interface ISchema : IProvideMetadata, IProvideDescription
{
	...
	/// <br/><br/>
	/// <see cref="Schema"/> initializes the list to include the Include <see cref="Directive"/>, the Skip <see cref="Directive"/> and the Deprecated <see cref="Directive"/> by default.
	/// </summary>

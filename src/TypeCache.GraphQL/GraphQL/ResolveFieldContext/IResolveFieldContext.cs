...
public interface IResolveFieldContext : IProvideUserContext
{
	...
	/// <summary>A <see cref="CancellationToken">CancellationToken</see> to indicate if and when the request has been canceled.</summary>
	...
	/// by all running resolvers and is not thread safe.
	/// </summary>
...
public interface IResolveFieldContext<out T> : IResolveFieldContext
{

...
internal sealed class ResolveFieldContextAdapter<T> : IResolveFieldContext<T>
{
	...
	internal ResolveFieldContextAdapter<T> Set(IResolveFieldContext baseContext)
	{
		...
		if (baseContext.Source is null && !_acceptNulls)
	...
	public IList<ExecutionError> Errors => _baseContext.Errors;
	...
	public IDictionary<string, object> InputExtensions => _baseContext.InputExtensions;

...
public static class Sequence
{
	...
	/// <param name="count">The # of items in the sequence.</param>
	/// </summary>
	/// <returns>A <c><paramref name="count"/></c> sequence of <c><see cref="TimeSpan"/></c> values.</returns>
	...
	/// Use Linq's Select method to cap values at a maximum or minimum.
	/// </summary>
	/// <param name="exponent">The exponent to use on the sequence (i^exponent).</param>
	/// <param name="count">The # of items in the sequence.</param>
	/// <returns>A <c><paramref name="count"/></c> sequence of <c><see cref="TimeSpan"/></c> values.</returns>
	[MethodImpl(AggressiveInlining), DebuggerHidden]
	...
	/// Use Linq's Select method to cap values at a maximum or minimum.
	/// </summary>
	/// <param name="increase">The size of the linearly increasing intervals of time.</param>
	/// <param name="count">The # of items in the sequence.</param>
	/// <returns>A <c><paramref name="count"/></c> sequence of <c><see cref="TimeSpan"/></c> values.</returns>
	[MethodImpl(AggressiveInlining), DebuggerHidden]

...
public static class LambdaFactory
{
	...
	{
		var parameters = parameterTypes.Select((type, i) => Invariant($"parameter{i + 1}").ParameterExpression(type)).ToArray();
	...
	{
		ParameterExpression parameter = nameof(parameter).ParameterExpression<T>();
	...
	{
		ParameterExpression parameter1 = nameof(parameter1).ParameterExpression<T1>();
		ParameterExpression parameter2 = nameof(parameter2).ParameterExpression<T2>();
		...
		Func<ParameterExpression, ParameterExpression, ParameterExpression, Expression> lambda)
	{
		ParameterExpression parameter1 = nameof(parameter1).ParameterExpression<T1>();
		ParameterExpression parameter2 = nameof(parameter2).ParameterExpression<T2>();
		ParameterExpression parameter3 = nameof(parameter3).ParameterExpression<T3>();
		...
		Func<ParameterExpression, ParameterExpression, ParameterExpression, ParameterExpression, Expression> lambda)
	{
		...
		ParameterExpression parameter2 = nameof(parameter2).ParameterExpression<T2>();
		ParameterExpression parameter3 = nameof(parameter3).ParameterExpression<T3>();
		ParameterExpression parameter4 = nameof(parameter4).ParameterExpression<T4>();
		...
		Func<ParameterExpression, ParameterExpression, ParameterExpression, ParameterExpression, ParameterExpression, Expression> lambda)
	{
		...
		ParameterExpression parameter3 = nameof(parameter3).ParameterExpression<T3>();
		ParameterExpression parameter4 = nameof(parameter4).ParameterExpression<T4>();
		ParameterExpression parameter5 = nameof(parameter5).ParameterExpression<T5>();
		...
		Func<ParameterExpression, ParameterExpression, ParameterExpression, ParameterExpression, ParameterExpression, ParameterExpression, Expression> lambda)
	{
		...
		ParameterExpression parameter4 = nameof(parameter4).ParameterExpression<T4>();
		ParameterExpression parameter5 = nameof(parameter5).ParameterExpression<T5>();
		ParameterExpression parameter6 = nameof(parameter6).ParameterExpression<T6>();
	...
	public static Expression<Comparison<T>> CreateComparison<T>(
		Func<ParameterExpression, ParameterExpression, Expression> lambda)
	{
		ParameterExpression value1 = nameof(value1).ParameterExpression<T>();
		ParameterExpression value2 = nameof(value2).ParameterExpression<T>();

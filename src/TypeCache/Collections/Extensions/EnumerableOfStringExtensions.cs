...
public static class EnumerableOfStringExtensions
{
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string> EachRegexReplace(this IEnumerable<string>? @this, string pattern, MatchEvaluator evaluator, RegexOptions options = REGEX_OPTIONS)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string> EachRegexReplace(this IEnumerable<string>? @this, string pattern, MatchEvaluator evaluator, TimeSpan timeout, RegexOptions options = REGEX_OPTIONS)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string> EachRegexReplace(this IEnumerable<string>? @this, string pattern, string replacement, RegexOptions options = REGEX_OPTIONS)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string> EachRegexReplace(this IEnumerable<string>? @this, string pattern, string replacement, TimeSpan timeout, RegexOptions options = REGEX_OPTIONS)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string> EachRegexReplace(this IEnumerable<string>? @this, string oldText, string newText, StringComparison comparison = STRING_COMPARISON)
		=> @this.Each(value => value.Replace(oldText, newText, comparison));
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string> IfRegexMatch(this IEnumerable<string>? @this, string pattern, RegexOptions options = REGEX_OPTIONS)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string> IfRegexMatch(this IEnumerable<string>? @this, string pattern, TimeSpan timeout, RegexOptions options = REGEX_OPTIONS)
	...
	public static string ToCSV(this IEnumerable<string>? @this)
		=> @this.Any()
			? @this.Map(text => text.IsNotBlank() ? (text.Contains(',') ? $"\"{text.Replace("\"", "\"\"")}\"" : text.Replace("\"", "\"\"")) : string.Empty).Join(',')
			: string.Empty;
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static Dictionary<string, V> ToDictionary<V>(this IEnumerable<KeyValuePair<string, V>>? @this, StringComparison comparison = STRING_COMPARISON)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static Dictionary<string, V> ToDictionary<V>(this IEnumerable<Tuple<string, V>>? @this, StringComparison comparison = STRING_COMPARISON)
		=> @this.ToDictionary(comparison.ToStringComparer());
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static Dictionary<string, V> ToDictionary<V>(this IEnumerable<ValueTuple<string, V>>? @this, StringComparison comparison = STRING_COMPARISON)
		=> @this.ToDictionary(comparison.ToStringComparer());
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static Dictionary<string, V> ToDictionary<V>(this IEnumerable<string>? @this, Func<string, V> valueFactory, StringComparison comparison = STRING_COMPARISON)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static Dictionary<string, V> ToDictionary<T, V>(this IEnumerable<T>? @this, Func<T, string> keyFactory, Func<T, V> valueFactory, StringComparison comparison = STRING_COMPARISON)
	...
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string[]> ToRegexSplit(this IEnumerable<string>? @this, string pattern, RegexOptions options = REGEX_OPTIONS)
		=> @this.Map(value => value.RegexSplit(pattern, options));

	/// <summary>
	/// <c>=&gt; @<paramref name="this"/>.To(value =&gt; value.RegexSplit(<paramref name="pattern"/>, <paramref name="timeout"/>, <paramref name="options"/>));</c>
	/// </summary>
	[MethodImpl(METHOD_IMPL_OPTIONS)]
	public static IEnumerable<string[]> ToRegexSplit(this IEnumerable<string>? @this, string pattern, TimeSpan timeout, RegexOptions options = REGEX_OPTIONS)
		=> @this.Map(value => value.RegexSplit(pattern, timeout, options));

...
namespace TypeCache.Extensions
{
	public static class ObjectExtensions
	{
		...
		{
			if (@this == null)
				throw new ArgumentNullException($"{nameof(AssertNotNull)}: [{name}] is null.");
		}
		...
		public static Type? GetTypeOf(this object @this, Type type)
		{
			...
			if (type.IsGenericType)
			{
				...
				return thisType.GetInterfaces().First(interfaceType => interfaceType.IsGenericType && interfaceType.GetGenericTypeDefinition() == type);
			}

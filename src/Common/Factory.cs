...
namespace Sam987883.Common
{
	public static class Factory
	{
		...
		/// <summary>
		/// Creates an instance of any class that has a default constructor using TypeCache.
		/// </summary>
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static IEqualityComparer<T> CreateReferenceComparer<T>() =>
			new CustomEqualityComparer<T>((x, y) => ReferenceEquals(x, y));

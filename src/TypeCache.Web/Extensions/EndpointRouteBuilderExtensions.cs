...
public static partial class EndpointRouteBuilderExtensions
{
	...
	extension(IEndpointRouteBuilder @this)
	{
		/// <summary>
		...
		/// </list>
		/// </summary>
		public IEndpointConventionBuilder MapGetRequestHeaders()
		...
		/// </list>
		/// </summary>
		public IEndpointConventionBuilder MapGetRequestHeaderValue(string? key = null)
			=> @this.MapGet(Invariant($"{Route.REQUEST_HEADERS}/{key.IfBlank("{key}")}"), async context =>
			{
		...
		/// </summary>
		public IEndpointConventionBuilder MapGetPing(string name, Uri requestUri)

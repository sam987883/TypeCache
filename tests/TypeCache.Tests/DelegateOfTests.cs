...
namespace TypeCache.Tests
{
	public class DelegateOfTests
	{
		...
		public void DelegateOfAction()
		{
			...
			Assert.Equal(typeof(Action<string, int, DateTime?>).Name, DelegateOf<Action<string, int, DateTime?>>.Name);
		...
		public void DelegateOfFunc()
		{
			...
			Assert.Equal(typeof(Func<string, int, DateTime?, bool>).Name, DelegateOf<Func<string, int, DateTime?, bool>>.Name);
		...
		public void DelegateOfPredicate()
		{
			...
			Assert.Equal(typeof(Predicate<string>).Name, DelegateOf<Predicate<string>>.Name);
